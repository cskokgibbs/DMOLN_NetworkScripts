...
INPUT_DIR = '~/fi-inferelator_sc/LaminaFinalNets/data'
OUTPUT_DIR = '~/fi-inferelator_sc/LaminaFinalNets'
TF_NAMES = "Lamina_DE_FlyFactor_TFs_070921.txt"
...
worker.set_file_paths(input_dir=INPUT_DIR, output_dir=OUTPUT_DIR, tf_names_file=TF_NAMES,
                      gold_standard_file = 'P48_Lamina_MergedDA_DE_goldstandard_091321.tsv')
worker.set_file_properties(expression_matrix_columns_are_genes=True)
worker.set_count_minimum(0.05)
worker.set_file_paths(gene_names_file="Lamina_P24-48GRP_DE_genes.txt")

worker.append_to_path('output_dir', "Lamina_MergedDA_network_Norm2_shuffled_010922")
...
P24P36P48 = worker.create_task(task_name="P24-P48", tf_names_file=TF_NAMES,expression_matrix_columns_are_genes=True, 
                           ...
                           priors_file='P48_Lamina_MergedDA_combinedFimoScores_091321.tsv')
P24P36P48.set_expression_file(h5ad="Zipursky_Lamina_norm2_sparse_expression.h5ad")
...
P30P40P50 = worker.create_task(task_name="P30-P50", tf_names_file=TF_NAMES,expression_matrix_columns_are_genes=True,
                           extract_metadata_from_expression_matrix=False, workflow_type="tfa",
                           priors_file='P48_Lamina_MergedDA_combinedFimoScores_091321.tsv')
P30P40P50.set_expression_file(h5ad="Desplan_Lamina_norm2_sparse_expression.h5ad")
